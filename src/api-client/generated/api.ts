...
export const getGetWaitlistCountQueryOptions = <TData = Awaited<ReturnType<typeof getWaitlistCount>>, TError = ErrorType<unknown>>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getWaitlistCount>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWaitlistCountQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWaitlistCount>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetWaitlistCount<TData = Awaited<ReturnType<typeof getWaitlistCount>>, TError = ErrorType<unknown>>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getWaitlistCount>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useGetWaitlistCount<TData = Awaited<ReturnType<typeof getWaitlistCount>>, TError = ErrorType<unknown>>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getWaitlistCount>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get waitlist count
